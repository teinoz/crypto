...
SECRET_KEY = 'django-insecure-f0o*57y-qmuy(+ci4=-!(scu9@ta*l1t-xgx^0aiheuupprx-4'
...
DATABASES = {
        'default': {
            ...
            'CLIENT': {
	        'host': 'mongodb+srv://dbadmi:dbpass@cluster0.2agwj.mongodb.net/?retryWrites=true&w=majority'
	    }
        }
}
